...
{
	MPU_Get_Accelerometer(&(mpu6050.Acc_I16.x),&(mpu6050.Acc_I16.y),&(mpu6050.Acc_I16.z));	//得到加速度传感器数据
	MPU_Get_Gyroscope(&(mpu6050.Gyro_I16.x),&(mpu6050.Gyro_I16.y),&(mpu6050.Gyro_I16.z));	//得到陀螺仪数据
	ACC_Flitter();		 	 //加速度计预滤波
}
